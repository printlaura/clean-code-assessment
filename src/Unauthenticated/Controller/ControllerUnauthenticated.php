...
class ControllerUnauthenticated
{
    ...
    /**
     * Executes an action that is being selected depending on the requests http method,
     * and it's path from the action dictionaries in this class.
     *
     * @param $logger
    ...
    /**
     * Executes an action that is being selected depending on action tag in its json body from the action dictionaries in this class.
     *
    ...
    /**
     * Json decodes and parses request
     *
    ...
    /**
     * Selects action from the action dictionaries, using the requets http method and uri path
     *
     * @param LoggerInterface $logger  logger reference
     * @param Request         $request
     *
